...
% cleveref requires that it is loaded after hyperref
\usepackage[nameinlink]{cleveref}
\crefname{equation}{Eqn.}{Eqns.}
\Crefname{equation}{Equation}{Equations}
\creflabelformat{equation}{#2#1#3}   % drop the parentheses around equation numbers
...
\copyrightinfo{2026}{The Authors. This work is an open access article under the {\color{blue}{\href{https://creativecommons.org/licenses/by-sa/4.0/}{CC BY-SA 4.0}}} license}
...
%    This is the version(s) that was used to generate the results. If the
%    procedures are compatible with other versions, this can be mentioned in the
